...
{{< block class="heading1 mt5 mb3 w-90 mw8 center" id="block-2" >}}
  <span class="teal dn dib-ns">\></span> Benefícios<span class="teal dn dib-ns">_</span>
{{< /block >}}

{{< emphasis-grid eg-controle-fiado-beneficios >}}

{{< block class="heading1 mt5 mb3 w-90 mw8 center" id="block-2" >}}
  <span class="teal dn dib-ns">{</span>O Software<span class="teal dn dib-ns">}:</span>
{{< /block >}}

{{< block class="w-90 mw8 center" >}}
  {{< block class="p mw6" >}}
  Se ainda não se sente confiante, você pode baixar uma versão básica do Cashd que
  funciona exclusivamente na máquina onde está instalado. É gratuito e você já pode
  baixar agora.
  {{< /block >}}
{{< /block >}}
