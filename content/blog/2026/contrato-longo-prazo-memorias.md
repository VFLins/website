...
O ciclo de alta do preço das memórias já completou um ano no mês passado, e ainda
temos indícios de que estes preços ainda vão continuar por algum tempo. E analistas
preveem que boa parte dos _data centers_ que estão em construção, já têm demanda de
computação prevista para os próximos anos[^2].
...
capacidade de absorver toda a demanda disponível com as instalações que estão sendo
construídas agora.


### Interesse dos consumidores finais

Isto se torna um problema quando os consumidores finais começam a se decepcionar com os
produtos já oferecidos atualmente, e passam a perder interesse nas capacidades da IA
generativa que conhecemos hoje:
...
estas empresas investem valores tão altos?

A resposta para isto está na expectativa de retorno que o mercado prevê para este
...
[^2]: **CBRE**.
[U.S. Real Estate Market Outlook Midyear Review 2026 | Data Centers](https://www.cbre.com/insights/books/us-real-estate-market-outlook-midyear-review-2026/data-centers).

[^3]: **O Globo**.
['Tokenmaxxing' flopou? Agentes de IA prometeram eficiência, mas estão entregando
boletos altíssimos](https://oglobo.globo.com/economia/tecnologia/noticia/2026/07/19/tokenmaxxing-flopou-agentes-de-ia-prometeram-eficiencia-mas-estao-entregando-boletos-altissimos.ghtml).

[^4]: [**Google Trends**](https://trends.google.com.br/explore?q=Gemini%2Cclaude%2Ccopilot%2Cchatgpt&date=today%205-y&geo=Worldwide).

[^5]: **it forum**.
[74% das empresas já interromperam uso de agentes de IA após falhas operacionais](https://itforum.com.br/noticias/74-das-empresas-interromperam-uso-de-agentes-de-ia-apos-falhas/).

[^6]: **Value Add VD**.
[2026 AI Capex Guidance by Company](https://valueaddvc.com/ai-spending).

[^7]: **Statista**.
[The AI Market Is Poised for Explosive Growth](https://www.statista.com/chart/35510/ai-market-growth-forecasts-by-segment/).
